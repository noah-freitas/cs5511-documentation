...
var classes = {
	...
	description:"Survey of the human fossil record, primate social behavior and comparative anatomy, genetics, and human diversity. The impact of human evolution on early and future global environments; issues surrounding future adaptation.",	
		section: [{
			sectionNumber : 0080,
			day : [2,4],
			room: "1564",
	...
	description:"General principles of chemistry including atomic theory, bonding, stoichiometry, kinetic-molecular theory, properties of mixtures, the periodic table, and thermodynamics. First semester of a one year program of general chemistry.",	
		section: [{
			sectionNumber : 1298,
			day : [1,3],
			room: "1910",
